		...
		<c:if test="${!empty validationErrorFlag}">
            ...
            <tr>
                ...
                <td class="inputField">
                    ...
                    <br>
                    <fmt:message key="regiao"/>:
                    <select name="cidade">
                      <c:forEach begin="1" end="10" var="cidade">
                        <option value="${cidade}"
                                <c:if test="${param.cidade eq cidade}">selecionar</c:if>>${cidade}</option>
                      </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <input type="submit" value="<fmt:message key='concluir'/>">
                </td>
            </tr>
        </table>
    </form>
