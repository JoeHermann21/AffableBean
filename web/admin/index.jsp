<div id="adminMenu" class="alignLeft">
    <p><a href="<c:url value='viewCustomers'/>">ver todos os clientes</a></p>

    <p><a href="<c:url value='viewOrders'/>">ver todos os pedidos</a></p>
...
<c:if test="${!empty clienteLista}">
    ...
    <table id="adminTabela" class="detalhesTabela">
        ...
        <c:forEach var="clientes" items="${clienteLista}" varStatus="iter">
    ...
    <table id="adminTable" class="detailsTable">
        ...
        <tr class="tableRow"
            ...
            <td colspan="2">
                ...
                <a href="customerRecord?${cliente.id}" class="noDecoration">
